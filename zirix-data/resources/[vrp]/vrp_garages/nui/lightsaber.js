        ...
        $('#carros').html(`
            ...
            ${nameList.map((item) => (`
				<div class="carro" data-carro-name="${item.name}">
                    <div class="imagem-carro"><img src="http://192.99.251.232:3554/images/vrp_vehicles/${item.name}.png"/></div>
                    ...
                    <div class="status">
                        ...
                        <div class="status-motor">
                            ...
                            <div class="icone-motor"><img src="http://192.99.251.232:3554/images/vrp_vehicles/motor.png"/></div>
                        ...
                        <div class="status-chassis">
                            ...
                            <div class="icone-chassis"><img src="http://192.99.251.232:3554/images/vrp_vehicles/chassis.png"/></div>
                        ...
                        <div class="status-fuel">
                            ...
                            <div class="icone-fuel"><img src="http://192.99.251.232:3554/images/vrp_vehicles/combustivel.png"/></div>
                    ...
                    <div class="licenca">
                        ...
                        <div class="licenca-tax">
                            <div class="icone-tax"><img src="http://192.99.251.232:3554/images/vrp_vehicles/tax.png"/></div>
                            <div class="texto-tax"><p>${item.ipva}</p></div>
                        </div>
                        <div class="licenca-valor">
                            <div class="icone-valor"><img src="http://192.99.251.232:3554/images/vrp_vehicles/money.png"/></div>
