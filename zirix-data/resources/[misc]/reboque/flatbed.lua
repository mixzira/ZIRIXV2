...
function drawMarker(pos)
    ...
    if dist < 25.0 then
        DrawMarker(1, pos, vector3(0.0, 0.0, 0.0), vector3(0.0, 0.0, 0.0), vector3(1.0, 1.0, 1.0), 234, 203, 102, 180)
        if dist < 1.5 then
            return true
        end
    end
                        ...
                        if IsControlJustPressed(0, 47) then
                            if attached then
                                ...
                                if newCar ~= 0 then
                                    ...
                                    AttachEntityToEntity(newCar, bed, 0, attachmentOffset[1] + vector3(0.0, 0.0, carPos.z - bedPos.z - 0.68), attachmentOffset[2], 0, 0, false, 0, 0, 1)
                                    car = newCar
